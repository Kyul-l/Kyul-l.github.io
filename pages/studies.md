...
<div class="studies-page">
  ...
  <div class="studies-spread" role="main" aria-label="Studies index">
    ...
    <div class="studies-spread__right">
      <p class="studies-spread__heading">Latest entry</p>
      <hr class="studies-spread__rule" aria-hidden="true">
      ...
      <div class="studies-preview" aria-live="polite" aria-label="Entry preview">
        ...
        {% if latest %}
          ...
          {% if latest.hypothesis %}
            <div class="studies-preview__section">
              <span class="studies-preview__section-label">Hypothesis</span>
              <p class="studies-preview__section-body">{{ latest.hypothesis }}</p>
            </div>
          {% endif %}
          {% if latest.finding %}
            <div class="studies-preview__section">
              <span class="studies-preview__section-label">Finding</span>
              <p class="studies-preview__section-body">{{ latest.finding }}</p>
            </div>
          {% endif %}
          {% if latest.reflection %}
            <div class="studies-preview__section">
              <span class="studies-preview__section-label">Reflection</span>
              <p class="studies-preview__section-body">{{ latest.reflection }}</p>
            </div>
          {% endif %}
        ...
        {% for entry in series_entries_js %}
          {
            ...
            "hypothesis": {{ entry.hypothesis | default: "" | jsonify }},
            "finding":    {{ entry.finding | default: "" | jsonify }},
            "reflection": {{ entry.reflection | default: "" | jsonify }},
